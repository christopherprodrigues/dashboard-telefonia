                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {loading ? (
                            ...
                            data.map((call, index) => (
                                <tr key={index}>
                                    <td className="px-6 py-4 whitespace-nowrap">{call.source}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{call.destination}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{call.duration}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{call.sip_code}</td>
                                </tr>
                            ))
                        )}
                    </tbody>
